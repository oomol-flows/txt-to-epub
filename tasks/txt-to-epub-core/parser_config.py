...
class ParserConfig:
    ...
    def from_yaml(cls, yaml_path: str) -> 'ParserConfig':
        ...
        try:
            ...
            config = cls(
                min_chapter_length=config_data.get('min_chapter_length', 500),
                min_section_length=config_data.get('min_section_length', 100),
                enable_chapter_validation=config_data.get('enable_chapter_validation', True),
                enable_length_validation=config_data.get('enable_length_validation', True),
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> 'ParserConfig':
        ...
        """
        return cls(
            min_chapter_length=config_dict.get('min_chapter_length', 500),
            min_section_length=config_dict.get('min_section_length', 100),
            enable_chapter_validation=config_dict.get('enable_chapter_validation', True),
            enable_length_validation=config_dict.get('enable_length_validation', True),
